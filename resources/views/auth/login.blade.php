...
<style type="text/css">
	body{
		...
		background: url('{{URL::to('asset/images/foto_sekolah.jpg')}}') no-repeat center center fixed; 
...
<div class="col-md-4 col-md-offset-4 well" id="loginForm">
	<center>  
		<img src="{{ URL::to('img/logo_sklh.png') }}" height="180px" width="260px" id="logo-sekolah">
		<h3>Login</h3>
	</center>
		@if(count($errors) > 0)
