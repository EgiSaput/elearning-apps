...
@section('content')
      ...
      <div class="box-header with-border">        
        ...
        <div class="pull-right"> 
          @if(Auth::user()->level == 12)
            ...
            <a href="{{ url('guru/soal_ujian/'.$id_soal.'/detail') }}" class="btn btn-primary btn-xs">
    ...
    <div style="display: block;" class="box-body">                         
        @if(Auth::user()->level == 12)
          <form id="formUjianEdit" class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="{{ url('guru/soal_ujian/'.$id_soal.'/simpanedit') }}">
        @else
          ...
          <div class="form-group"> 
             <div class="col-md-8 col-md-offset-5">
               <button type="submit" class="btn btn-primary" id="button-reg">
                ...
                @if(Auth::user()->level == 12)
                  <a href="{{ url('guru/soal_ujian/'.$id_soal.'/detail') }}" title="Cancel">
