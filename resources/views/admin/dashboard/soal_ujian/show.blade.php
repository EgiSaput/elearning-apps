...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        {{ Form::open(array('method' => 'put', 'role' => 'form', 'class' => 'form-horizontal', 'id' => 'form-ujian', 'action' => array(
        'Admin\SoalUjianController@update', $userjawablembar->id_nilai_ujian_pilgan, $soal->id_soal )) ) }}
          ...
          <div class="form-group" >
            <div class="col-md-12">
             <label for="pertanyaan">Pertanyaan</label>
              <textarea class="form-control my-editor" name="pertanyaan" value="{{$soal->pertanyaan}}" placeholder="Pertanyaan" style="height: 100px" >
                {{$soal->pertanyaan}}
              </textarea>
          ...
          <!--  gambar -->
            <div class="form-group" >
              <div class="col-md-3">
                ...
                <img src="{{ URL::to('upload_gambar/'.$soal->gambar) }}" style="width: 210px; height: 210px; display: block;">
        ...
        <div class="list-group">
            ...
            <a class="list-group-item well-lg">
                {{Form::radio('jawaban', $answer->id_jawaban_soal_ujian)}}
                &nbsp;
                <strong>{{chr(65 + $index)}}.</strong> {{$answer->jawaban}}
            </a>
            @endforeach
            @else
        ...
        <div class="pull-right clearfix">
            ...
            @endif
            {{Form::submit($is_last_soal ? 'Submit Ujian' : 'Lanjut', array('class' => 'btn btn-success btn-lg'))}}
        </div>
        </div>
        {{ Form::close()}}
...
var x = setInterval(function() {
  ...
  // If the count down is finished, auto submit
  if (distance < 0) {
    clearInterval(x);
    document.getElementById("status").innerHTML = "WAKTU HABIS!";
