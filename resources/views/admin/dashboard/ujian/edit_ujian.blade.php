            ...
            <div class="col-md-6"> 
              ...
              <div class="form-group" >
               ...
               <label class="col-sm-4 control-label" style="text-align: left;">Jam Mulai</label>
                 <div class="col-sm-8">                  
                    <input type="time" class="form-control" name="jam_mulai" value="{{ $jam_mulai ?? '' }}" style="height: 35px">
                    <small class="help-block"></small>
                 </div>
               </div>
               ...
               <label class="col-sm-4 control-label" style="text-align: left;">Jam Selesai</label>
                 <div class="col-sm-8">                  
                    <input type="time" class="form-control" name="jam_selesai" value="{{ $jam_selesai ?? '' }}" style="height: 35px">
                    <small class="help-block"></small>
                 </div>
               </div>
