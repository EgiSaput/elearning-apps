          ...
          <div class="col-md-12" style="margin-left:0%;">
                ...
                <div class="form-group">
                 ...
                 <div class="col-sm-8">               
                  ...
                  <?php if (Auth::user()->level  == 12): ?>
                    ...
                    @if(isset($dataMapelList) && count($dataMapelList))
                      @foreach($dataMapelList as $m)
                        <option value="{{ $m->id_mapel }}">id mata pelajaran : {{ $m->id_mapel }} | nama : {{ $m->nama_mapel }}</option>
                      @endforeach
                    @else
            ...
            <div class="col-md-6"> 
              <!-- general right form elements -->
               ...
               <div class="form-group" style="height: 35px">
               <label class="col-sm-4 control-label" style="text-align: left;">Jam Mulai</label>
                 <div class="col-sm-8">                  
                    <input type="time" class="form-control" name="jam_mulai" value="" style="height: 35px">
                    <small class="help-block"></small>
                 </div>
               </div>

               <div class="form-group" style="height: 35px">
               <label class="col-sm-4 control-label" style="text-align: left;">Jam Selesai</label>
                 <div class="col-sm-8">                  
                    <input type="time" class="form-control" name="jam_selesai" value="" style="height: 35px">
                    <small class="help-block"></small>
                 </div>
               </div>
