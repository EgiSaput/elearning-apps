...
@section('content')
    ...
    <div class="box box-danger">
      ...
      <h3 class="box-title"> Form Tambah Data Mata Pelajaran</h3>              
    </div>
    <div style="display: block;" class="box-body">
      <form id="formMapelTambah" class="form-horizontal" role="form" method="POST" action="{{ url('admin/mapel/tambah') }}" >
